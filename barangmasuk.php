            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card">
                            ...
                            <div class="card-body">
                                <form method="GET" action="barangmasuk.php">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <input class="form-control" id="cari" name="cari"
                                                placeholder="Masukkan tanggal pencarian">
                                        </div>
                                        <div class="col-md">
                                ...
                                if (isset($_GET['cari'])) {
                                    ...
                                    while ($r = mysqli_fetch_array($cr)) {
                                        ...
                                        if (!isset($data_by_date[$tglmasuk])) {
                                            $data_by_date[$tglmasuk] = [];
                                        }
                                        $data_by_date[$tglmasuk][] = $r;
                                    }
                                ?>
                                                ...
                                                <div class="card-body">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            <?php 
                                                            $nomor = 1;
                                                            foreach ($masuk as $barangmasuk) { 
                                                                $idmasuk = $barangmasuk['id'];
                                                                $namabarang = $barangmasuk['nama_barang'];
                                                                $jumlah = $barangmasuk['jumlah_barang'];
                                                                $jenis = $barangmasuk['jenis_barang'];
                                                            ?>
                                                            <tr>
